...
- Carga: Almacenamiento de los datos en el Data Werehouse.
...
Para esta etapa utilizamos como carga inicial los datasets disponibles de ambas plataformas, posteriormente se extraerán dichos datos a través de consultas a Yelp Open Dataset y Google Places para hacer cargas de datos automáticas.
...
En la primera etapa, se emplearon los datasets provenientes de la API de Google Places y Datasets de la plataforma de Yelp para obtener datos de ubicaciones y reseñas de lugares. La API de Google Places junto con Google Maps nos proporcionan metadatos de los lugares, mientras que los Datasets de Yelp nos brinda información adicional de la reseñas estructurada en distintos archivos.
...
1. Extracción de datos:
  1. Tecnología: Google Places API, Yelp Open Dataset.
  2. Descripción: Utilizamos para la carga inicial los dataset provenientes de la API de Google Places y de Yelp para extraer datos de ubicaciones y reseñas de lugares en Estados Unidos.
  3. Detalles adicionales:
    ...
    2. Los datos de Google Maps se dividieron en dos partes:
      ...
      2. Reviews por estado: Esta organizado en 51 carpetas, una por cada estado de Estados Unidos, donde se almacenaron las reseñas correspondientes a los bares en cada estado.
...
1. Limpieza y transformación de datos:
  1. Tecnología: Python, pandas, json, re, os, pyarrow, fastparquet.
  2. Descripción: Utilizamos Python junto con las bibliotecas detalladas en el inciso '1.' para limpiar y transformar los datos extraídos.
  3. Detalles adicionales:
